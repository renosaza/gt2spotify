...
- Spotify Web API playback state, devices, play, pause, next, previous, and volume
...
6. Enable GitHub Pages for the repository and publish the `/docs` directory. Until the PR is merged, Pages may be pointed temporarily at the feature branch; after merge, use `main` and `/docs`.
...
12. Test refresh, play, pause, previous, next, volume down/up, and the absolute volume slider.
